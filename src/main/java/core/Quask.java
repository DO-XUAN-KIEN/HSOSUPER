    ...
    public static void quask_hon_gio(Session conn, byte index) throws IOException {
        switch (index) {
            case 0: {
                ...
                List<Integer> longcanh = new ArrayList<>(java.util.Arrays.asList(0, 3, 8, 9, 10, 11));
                List<Integer> duclo = new ArrayList<>(java.util.Arrays.asList(33, 44, 45));
                List<Integer> verandom = new ArrayList<>(java.util.Arrays.asList(52, 53, Util.random(357, 364), 377, 205, 206, 207));
                for (int i = 0; i < 2; i++) {
                    int ran = Util.random(102);
                    if (ran > 101.9999999){
                    ...
                    } else if (ran > 100.9999999) { // sách 110
                    ...
                    } else if (ran > 99.9999999 && ran < 100) { // vé tặng tiền
                        short id = (short) 379;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 98.9999999 && ran < 99) { // vé cầu hôn
                        short id = (short) 380;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if(ran < 97 && ran >= 96) {
                        short id = (short) Util.random(328, 335);
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 95 && ran < 98) { // thú cưỡi vv
                        short id = Util.random(thucuoi, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 65 && ran < 80) { // mảnh sách 110
                    ...
                    } else if (ran > 50 && ran < 65) { // mảnh hồ quang
                        short id = (short) Util.random(481, 483);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 45 && ran < 50) { // lông cánh
                        short id = Util.random(longcanh, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 20 && ran < 35) { // đục lỗ
                        short id = Util.random(duclo, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran > 5 && ran < 20) { // vé linh tinh
                        short id = Util.random(verandom, new ArrayList<>()).shortValue();
            ...
            case 1: {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (ran > 101.999999){
                        ...
                        ids.add(new box_item_template(id, (short) 1, (byte) 3));
                        conn.p.item.add_item_bag3_default(id, 0, false);
                    } else if (ran > 100.99999) { // sách 110
                        short idsach = (short) Util.random(4577, 4585);
                        ids.add(new box_item_template(idsach, (short) 1, (byte) 3));
                        conn.p.item.add_item_bag3_default(idsach, 0, false);
                    } else if (ran > 99.99999 && ran < 100) { // vé tặng tiền
                        short id = (short) 379;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 96.99999 && ran < 97) { // vé cầu hôn
                        short id = (short) 380;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 90 && ran < 94) { // thú cưỡi vv
                        short id = Util.random(thucuoi, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 40 && ran < 50) { // lông cánh
                        short id = Util.random(longcanh, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
            ...
            case 2: { // ghép chữ
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (ran >= 100.9999) {
                        ...
                        ids.add(new box_item_template(id, (short) 1, (byte) 3));
                        conn.p.item.add_item_bag3_default(id, 0, false);
                    } else if (ran >= 99.9999) { // sách 110
                        short idsach = (short) Util.random(4577, 4585);
                        ids.add(new box_item_template(idsach, (short) 1, (byte) 3));
                        conn.p.item.add_item_bag3_default(idsach, 0, false);
                    } else if (ran > 97.9999 && ran < 98) { // vé tặng tiền
                        short id = (short) 379;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 96.9999 && ran < 97) { // vé cầu hôn
                        short id = (short) 380;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 80 && ran < 91) { // thú cưỡi vv
                        short id = Util.random(thucuoi, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
    ...
    public static void  qua_sk_tet(Session conn, byte index) throws IOException {
        switch (index){
            case 0: {// dâng bánh
                ...
                for (int i = 0; i < 2; i++) {
                    int ran = Util.random(101);
                    if (ran > 100.9999999) { // sách 110
                        short idsach = (short) Util.random(4577, 4585);
                        ids.add(new box_item_template(idsach, (short) 1, (byte) 3));
                        conn.p.item.add_item_bag3_default(idsach, 0, false);
                    } else if (ran > 99.999999 && ran < 100) { // vé tặng tiền
                        short id = (short) 379;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 70 && ran < 80) { // mảnh sách 110
                        short id = (short) Util.random(472, 480);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran > 55 && ran < 70) { // mảnh hồ quang
                        short id = (short) Util.random(481, 483);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran > 40 && ran < 45) { // lông cánh
                        short id = Util.random(longcanh, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
            ...
            case 1: {// pháo hoa
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (ran > 100.9999999) { // sách 110
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 75 && ran < 88) { // mảnh sách 110
                        short id = (short) Util.random(472, 480);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran > 55 && ran < 75) { // mảnh hồ quang
                        short id = (short) Util.random(481, 483);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
            ...
            case 2: { // ghép chữ
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (ran >= 99.9999) { // sách 110
                        ...
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 97.9999 && ran < 92) { // vé cầu hôn
                        short id = (short) 380;
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran > 77 && ran < 86) { // thú cưỡi vv
                        short id = Util.random(thucuoi, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 4));
                        conn.p.item.add_item_bag47(id, quant, (byte) 4);
                    } else if (ran >= 65 && ran < 75) { // mảnh sách 110
                        short id = (short) Util.random(472, 480);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 55 && ran < 65) { // mảnh hồ quang
                        short id = (short) Util.random(481, 483);
                        short quant = (short) Util.random(0, 5);
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 40 && ran < 55) { // lông cánh
                        short id = Util.random(longcanh, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
                    } else if (ran >= 20 && ran < 40) { // đục lỗ
                        short id = Util.random(duclo, new ArrayList<>()).shortValue();
                        short quant = 1;
                        ids.add(new box_item_template(id, quant, (byte) 7));
                        conn.p.item.add_item_bag47(id, quant, (byte) 7);
