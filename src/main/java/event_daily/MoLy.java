...
public class MoLy {
    ...
    public static short[] item_mo_ly = new short[]{4640, 4639, 4641, 4638, 4677, 4678, 4680, 4681, 4683, 4684};// id item mo ly
    public static byte[] item_mo_ly_type = new byte[]{3, 3, 3, 3, 3, 3, 3, 3, 3, 3};// id ở item mấy
    public static byte[] item_mo_ly_percent = new byte[]{5, 5, 5, 5, 1, 1, 1, 1, 1, 1};// tỉ lệ ra
